...
def main():
    ...
    alpha_canvas = alpha_canvas.draw_rectangle(50, 100, 200, 200, "#FF000080")  # 50% red
    alpha_canvas = alpha_canvas.draw_rectangle(150, 150, 200, 200, "#00FF0080")  # 50% green
    alpha_canvas = alpha_canvas.draw_rectangle(250, 100, 200, 200, "#0000FF80")  # 50% blue

...
print(f"  • Edge Detection: 7")
print(f"  • Sharpening: 5")
print(f"  • Stylistic: 8")
print(f"  • Noise: 3")
print(f"  • Morphological: 5")
print(f"  • Artistic: 5")
print(f"  • Color Effects: 3")
print(f"  • CSS-like Filters: 5")
print(f"  • Adjustments: 2")
print(f"  • Combined Effects: 4")

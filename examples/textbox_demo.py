...
for test_size in range(100, 10, -5):
    ...
    if w <= box_width and h <= box_height:
        ...
        img3 = img3.add_text(
            target_text, (text_x, text_y), size=test_size, color=(255, 0, 0, 255)
        )
...
img5 = img5.add_text_multiline(
    poem, (x, y), size=32, color=(0, 0, 128, 255), line_spacing=1.5, align="center"
)

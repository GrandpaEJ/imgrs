...
def create_anchor_comparison():
    ...
    image = image.draw_circle(
        center_x, center_y, 5, (0, 255, 0, 255)  # Green dot
    )
...
def create_practical_anchor_examples():
    ...
    # Add descriptions
    descriptions = [
        ("Button Text (mm)", button_x + button_width // 2, button_y + button_height + 20),
...
def main():
    ...
    try:
        ...
        output_path1 = os.path.join(os.path.dirname(__file__), 'output', 'text_anchors_positions.png')
        ...
        output_path2 = os.path.join(os.path.dirname(__file__), 'output', 'text_anchors_comparison.png')
        ...
        output_path3 = os.path.join(os.path.dirname(__file__), 'output', 'text_anchors_practical.png')
        practical_image.save(output_path3)
        print(f"✅ Practical anchor examples saved to: {output_path3}")
        
        print(f"\n📋 Anchor Features Demonstrated:")
        print("   • All 12 anchor positions (tl, tm, tr, ml, mm, mr, bl, bm, br, sl, sm, sr)")

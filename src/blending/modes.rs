...
pub fn blend_pixels(
    ...
    match blend_mode {
        ...
        BlendMode::Xor => {
            ...
            let final_r = (overlay_r * overlay_a * (1.0 - base_a) + base_r * base_a * (1.0 - overlay_a)) / final_a;
            let final_g = (overlay_g * overlay_a * (1.0 - base_a) + base_g * base_a * (1.0 - overlay_a)) / final_a;
            let final_b = (overlay_b * overlay_a * (1.0 - base_a) + base_b * base_a * (1.0 - overlay_a)) / final_a;
            return (
                (final_r * 255.0) as u8,
                (final_g * 255.0) as u8,
                (final_b * 255.0) as u8,
